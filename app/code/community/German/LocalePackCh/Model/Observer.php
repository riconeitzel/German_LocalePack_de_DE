...
class German_LocalePackCh_Model_Observer {
    ...
    {
        return (string)Mage::app()->getConfig()->getNode('modules/German_LocalePackCh/version');
    }
    ...
    public function getManageUrl(){
        return Mage::helper("adminhtml")->getUrl('adminhtml/system_config/edit', array('section'=>'localepackch'));
    }
}
